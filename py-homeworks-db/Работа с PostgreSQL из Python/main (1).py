...
with psycopg2.connect(database = 'netology_db', user = 'postgres', password = 'postgres') as conn:
    ...
    # append_phone(conn, 'Влад', 'Владов', '89998889988')

    # update_client(conn, id=1, first_name='Влад', last_name='Владов')
    # update_client(conn, first_name='Влад', last_name='Владов', email='vlad_ov@mail.ru')
    # update_client(conn, first_name='Влад', last_name='Владов', email='vlad_ov1@mail.ru', phone='86669998877')
    # delete_phone(conn, id=1, phone='86665554466')
    # delete_phone(conn, first_name='Влад', last_name='Владов', phone='86669998877')
    # delete_cleint(conn, first_name='Сергей', last_name='Сергеев')

    # search_client(conn, first_name='Влад', last_name='Иванов')
    # search_client(conn, email='vlad_ov@mail.ru', phone='81112223311')
conn.close()
